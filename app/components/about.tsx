      ...
      <>
        ...
        > <div className="py-20 flex flex-col md:flex-row items-center md:justify-between">
         <div className=""> <h2
          ...
          <p
            className={`text-left w-full xl:w-3/5 md:w-4/5 sm:w-4/5 md:text-3xl text-sm font-light ${raleway.className}`}
          >
          ...
          <br /><br />
          <p
            className={`text-left w-full xl:w-2/5 md:w-4/5 sm:w-4/5 md:text-3xl text-lg font-light ${raleway.className}`}
          >
