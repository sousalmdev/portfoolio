...
export const Articles = () => {
  return (
    <div className="animate-fade-in-bottom pb-10 text-left w-11/12 md:w-full">
      ...
      <br />
      <p
        className={` w-full xl:w-2/5 leading-none md:w-4/5 sm:w-4/5 md:text-3xl  text-lg font-light `}
      >
        À medida que 2023 foi passando, eu decidi escrever sobre o que sei, com
        o objetivo de ajudar tanto iniciantes quanto profissionais experientes
        com curiosidades ou lições que aprendi ao longo do caminho. Aqui estão
        apenas alguns:
      </p>
      <br />
      <Accordionn />
